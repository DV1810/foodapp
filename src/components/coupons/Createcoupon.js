                      ...
                      <div className="form-row">
                        <div className="col-md-4 mb-3">
                          ...
                          <div className="input-group">
                            <input type="text" className="form-control" id="validationCustom18" placeholder="Title" required />
                          </div>
                        </div>
                        <div className="col-md-4 mb-3">
                          <label htmlFor="validationCustom18">Product Name</label>
                          <div className="input-group">
                            <input type="text" className="form-control" id="validationCustom18" placeholder="Product Name" required />
                        ...
                        <div className="col-md-4 mb-3">
                          <label htmlFor="validationCustom22">Coupon code</label>
                          <div className="input-group">
                            <select className="form-control" id="validationCustom22" required>
                              <option value>FREE100</option>
                              <option value>GET50</option>
                              <option value>FOOD120</option>
                              <option value>FESTIVAL</option>
                              <option value>NEW</option>
                              <option value>FIRSTORDER</option>
                            </select>
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationCustom23">Discount</label>
                          <div className="input-group">
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationCustom18">Expiry</label>
                          <div className="input-group">
                            <input type="text" className="form-control" id="validationCustom18" placeholder="Date" required />
                          </div>
                        </div>
                        <div className="col-md-12 mb-3">
                          <label htmlFor="validationCustom12">Description</label>
                          <div className="input-group">
                            <textarea rows={5} id="validationCustom12" className="form-control" placeholder="Details" required defaultValue={""} />
                            <div className="invalid-feedback">
                              details
                            </div>
                          </div>
